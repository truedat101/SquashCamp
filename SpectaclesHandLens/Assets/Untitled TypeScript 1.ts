...
//        LSTween.rawTween(800).onUpdate((args) => {
//            let elapsed = args.t as number
//            mat.mainPass.baseColor = new vec4(1,startColor.y, startColor.z, 1 - elapsed)
//        }).delay(700).start()
//        
//
//        LSTween.moveOffset(
